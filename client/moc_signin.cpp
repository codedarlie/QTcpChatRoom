...
template <> constexpr inline auto signIn::qt_create_metaobjectdata<qt_meta_tag_ZN6signInE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_goToSignUpButton_clicked'
...
void signIn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->switchToLobby(); break;
        case 2: _t->signInAccount(); break;
        case 3: _t->on_goToLobbyButton_clicked(); break;
        case 4: _t->on_goToSignUpButton_clicked(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (signIn::*)()>(_a, &signIn::switchTosignUp, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (signIn::*)()>(_a, &signIn::switchToLobby, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (signIn::*)()>(_a, &signIn::signInAccount, 2))
            return;
    }
}
...
// SIGNAL 0
void signIn::switchTosignUp()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void signIn::switchToLobby()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void signIn::signInAccount()
{
